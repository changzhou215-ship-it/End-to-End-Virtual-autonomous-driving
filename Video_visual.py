    ...
    for i, data_row in enumerate(driving_data):
        ...
        for r in range(rows):
            for c in range(cols):
                ...
                idx = r*cols + c
                cur_act = z[0, :, :, idx]
                cur_act = cv2.resize(cur_act, (180, 64))
                ax.set_axis_off()
